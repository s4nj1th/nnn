...
import {
  Brain, LayoutDashboard, FolderOpen, BookOpen,
  Settings, LogOut, Menu, X, ChevronLeft, Plus, User,
} from 'lucide-react';
        ...
        <AnimatePresence>
          {!collapsed && (
            ...
            >
              ...
              <span className="text-sm font-bold text-foreground whitespace-nowrap">NNN</span>
            </motion.div>
          )}
          {collapsed && (
        ...
        <DropdownMenu>
          ...
          <DropdownMenuContent align="end" side="top" className="w-48">
            <DropdownMenuLabel className="font-normal">
              <p className="text-xs font-medium">{profile?.username ?? 'My Account'}</p>
              <p className="text-[10px] text-muted-foreground truncate">{user?.email}</p>
            </DropdownMenuLabel>
            ...
            <ThemeToggle />
            <DropdownMenuSeparator />
            <DropdownMenuItem onClick={handleSignOut} destructive className="gap-2 cursor-pointer">
