        ...
        <div className="w-full max-w-sm">
          <div className="mb-8 text-center">
            ...
            <p className="text-sm text-muted-foreground">
              Start building neural networks for free. Please confirm your email after signing up.
            </p>
          </div>
                    ...
                    <div key={rule.label} className="flex items-center gap-2">
                      <div
                        className={cn(
                          ...
                          rule.test(password) ? 'bg-nnn-success' : 'bg-border'
                        )}
                      >
                        {rule.test(password) && <Check className="w-2 h-2 text-white" />}
                      </div>
                      <span
                        className={cn(
                          'text-xs transition-colors',
                          rule.test(password) ? 'text-nnn-success' : 'text-muted-foreground'
                        )}
                      >
                        {rule.label}
                      </span>
