...
export default function TermsPage() {
    return (
        <StaticPageLayout title="Terms of Service" updated="June 7, 2025">
            <p>
                By accessing or using Neural Network Nook (&quot;NNN&quot;), you
            ...
            <p>
                NNN is a visual neural network editor that lets you design,
                simulate, and export network architectures on an interactive
                canvas. Features may change or be discontinued at any time.
            </p>
            ...
            <h2>Your Content</h2>
            <p>
                You retain ownership of the neural network projects and data you
                create. By using NNN, you grant us a limited license to store,
            ...
            <p>
                The NNN platform, including its design, code, branding, and
                documentation, is owned by Neural Network Nook. Open-source
                components are used under their respective licenses.
            </p>

            <h2>Disclaimer</h2>
            <p>
                NNN is provided &quot;as is&quot; without warranties of any
                kind. We do not guarantee uninterrupted access, accuracy of
                simulations, or fitness for a particular purpose. Educational
                simulations are not production ML systems.
            </p>

            <h2>Limitation of Liability</h2>
            <p>
                To the fullest extent permitted by law, NNN shall not be liable
            ...
            <p>
                ...
                Disputes will be resolved through good-faith negotiation before
                formal proceedings.
            </p>
